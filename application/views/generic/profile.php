                  ...
                  <aside class="profile-nav col-lg-3">
                      <section class="panel">
                          <div class="user-heading round">
                              <a href="#">
                                  <img src="<?php echo base_url(); ?>themes/img/profile-avatar.jpg" alt="">
                              </a>
                              <!-- <input type="file" id="input-file-now-custom-1" class="dropify" data-default-file="<?php echo base_url(); ?>themes/img/profile-avatar.jpg" /> -->
                              <h1><?php echo $sess['firstname'].' '.$sess['lastname']; ?></h1>
                              <p><?=$sess['email']; ?></p>
                          </div>
